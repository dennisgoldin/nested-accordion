...
function toggle2() {
  if (storageState2 === "closed") {
      ...
      arrow2.className = "fa fa-arrow-down arrowIcon";
    ...
    arrow2.className = "fa fa-arrow-right arrowIcon";
  }
}
...
function toggle3() {
  if (storageState3 === "closed") {
      ...
      arrow3.className = "fa fa-arrow-down arrowIcon";
    ...
    arrow3.className = "fa fa-arrow-right arrowIcon";
  }
}
